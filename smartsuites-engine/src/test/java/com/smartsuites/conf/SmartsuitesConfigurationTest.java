...
public class SmartsuitesConfigurationTest {
    ...
    public void getAllowedOrigins2Test() throws MalformedURLException, ConfigurationException {
        ...
        SmartsuitesConfiguration conf  = new SmartsuitesConfiguration(this.getClass().getResource("/test-zeppelin-site2.xml"));
    ...
    public void getAllowedOrigins1Test() throws MalformedURLException, ConfigurationException {
        ...
        SmartsuitesConfiguration conf  = new SmartsuitesConfiguration(this.getClass().getResource("/test-zeppelin-site1.xml"));
        List<String> origins = conf.getAllowedOrigins();
    ...
    public void getAllowedOriginsNoneTest() throws MalformedURLException, ConfigurationException {
        ...
        SmartsuitesConfiguration conf  = new SmartsuitesConfiguration(this.getClass().getResource("/zeppelin-site.xml"));
        List<String> origins = conf.getAllowedOrigins();
        Assert.assertEquals(1, origins.size());
    }
