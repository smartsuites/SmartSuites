...
import com.smartsuites.helium.ApplicationContext;
import com.smartsuites.helium.ApplicationException;
import com.smartsuites.helium.ApplicationLoader;
import com.smartsuites.helium.HeliumAppAngularObjectRegistry;
...
import com.smartsuites.helium.Application;
import com.smartsuites.helium.HeliumPackage;
import com.smartsuites.interpreter.Constants;
...
import com.smartsuites.interpreter.InterpreterHookListener;
import com.smartsuites.interpreter.InterpreterHookRegistry;
...
import com.smartsuites.interpreter.LazyOpenInterpreter;
import com.smartsuites.interpreter.RemoteWorksController;
import com.smartsuites.interpreter.RemoteZeppelinServerResource;
...
import com.smartsuites.interpreter.thrift.ZeppelinServerResourceParagraphRunner;
...
import com.smartsuites.resource.WellKnownResourceName;
import com.smartsuites.scheduler.JobProgressPoller;
    ...
    private void processInterpreterHooks(final String noteId) {
      InterpreterHookListener hookListener = new InterpreterHookListener() {
        ...
        public void onPreExecute(String script) {
          String cmdDev = interpreter.getHook(noteId, InterpreterHookRegistry.HookType.PRE_EXEC_DEV);
          String cmdUser = interpreter.getHook(noteId, InterpreterHookRegistry.HookType.PRE_EXEC);
        ...
        public void onPostExecute(String script) {
          String cmdDev = interpreter.getHook(noteId, InterpreterHookRegistry.HookType.POST_EXEC_DEV);
          String cmdUser = interpreter.getHook(noteId, InterpreterHookRegistry.HookType.POST_EXEC);
