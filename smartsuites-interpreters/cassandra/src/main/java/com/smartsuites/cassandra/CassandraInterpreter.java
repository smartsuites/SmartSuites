...
import com.smartsuites.cassandra.InterpreterLogic;
import com.smartsuites.cassandra.JavaDriverConfig;
...
public class CassandraInterpreter extends Interpreter {
  ...
  public InterpreterResult interpret(String st, InterpreterContext context) {
    return (InterpreterResult) helper.interpret(session, st, context);
  }
