...
package com.smartsuites.elasticsearch.client;
...
import com.smartsuites.elasticsearch.ElasticsearchInterpreter;
import com.smartsuites.elasticsearch.action.ActionException;
import com.smartsuites.elasticsearch.action.ActionResponse;
import com.smartsuites.elasticsearch.action.AggWrapper;
import org.apache.commons.lang3.StringUtils;
import com.smartsuites.elasticsearch.action.HitWrapper;
            ...
            if (aggResult.has("buckets")) {
              ...
              while (buckets.hasNext()) {
                response.addAggregation(
                    new AggWrapper(AggWrapper.AggregationType.MULTI_BUCKETS, buckets.next().toString()));
              }
            }
            else {
              response.addAggregation(
                  new AggWrapper(AggWrapper.AggregationType.SIMPLE, aggregationsMap.toString()));
            }
