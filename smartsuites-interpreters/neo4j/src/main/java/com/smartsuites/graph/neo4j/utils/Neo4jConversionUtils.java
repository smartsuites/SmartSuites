...
package com.smartsuites.graph.neo4j.utils;
...
public class Neo4jConversionUtils {
  ...
  public static com.smartsuites.tabledata.Node toZeppelinNode(Node n,
    ...
    return new com.smartsuites.tabledata.Node(n.id(), n.asMap(),
        labels);
  }
  
  public static com.smartsuites.tabledata.Relationship
  toZeppelinRelationship(Relationship r) {
    return new com.smartsuites.tabledata.Relationship(r.id(), r.asMap(),
