...
import com.smartsuites.interpreter.{Interpreter, InterpreterContext, InterpreterResult}
...
class ScioInterpreter(property: Properties) extends Interpreter(property) {
  ...
  override def open(): Unit = {
    ...
    REPL.interpret("import com.smartsuites.scio.DisplaySCollectionImplicits._")
    REPL.interpret("import com.smartsuites.scio.DisplayTapImplicits._")
    REPL.interpret("import com.smartsuites.scio.ContextAndArgs")
  }
