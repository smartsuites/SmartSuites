...
import com.smartsuites.interpreter.BaseZeppelinContext;
...
import com.smartsuites.interpreter.WrappedInterpreter;
...
import com.smartsuites.spark.dep.SparkDependencyContext;
import com.smartsuites.spark.dep.SparkDependencyResolver;
  ...
  public void open() throws InterpreterException {
    ...
    synchronized (sharedInterpreterLock) {
      ...
      interpret("@transient val z = "
              + "_binder.get(\"z\").asInstanceOf[com.smartsuites.spark.SparkZeppelinContext]");
    ...
    intp.interpret("import com.smartsuites.spark.utils.DisplayUtils._");

    // Scala implicit value for spark.maxResult
    intp.interpret("import com.smartsuites.spark.utils.SparkMaxResult");
