...
import com.smartsuites.display.ui.OptionInput;
...
public class SparkZeppelinContext extends BaseZeppelinContext {
  ...
  public SparkZeppelinContext(
    ...
    interpreterClassMap.put("spark", "com.smartsuites.spark.SparkInterpreter");
    interpreterClassMap.put("sql", "com.smartsuites.spark.SparkSqlInterpreter");
    interpreterClassMap.put("dep", "com.smartsuites.spark.DepInterpreter");
    interpreterClassMap.put("pyspark", "com.smartsuites.spark.PySparkInterpreter");
