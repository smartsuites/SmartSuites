...
# getZeppelinR
.zeppelinR = SparkR:::callJStatic("com.smartsuites.spark.ZeppelinR", "getZeppelinR", hashCode)

# setup spark env
assign(".sc", SparkR:::callJStatic("com.smartsuites.spark.ZeppelinRContext", "getSparkContext"), envir = SparkR:::.sparkREnv)
assign("sc", get(".sc", envir = SparkR:::.sparkREnv), envir=.GlobalEnv)
if (version >= 20000) {
  assign(".sparkRsession", SparkR:::callJStatic("com.smartsuites.spark.ZeppelinRContext", "getSparkSession"), envir = SparkR:::.sparkREnv)
  assign("spark", get(".sparkRsession", envir = SparkR:::.sparkREnv), envir = .GlobalEnv)
  assign(".sparkRjsc", SparkR:::callJStatic("com.smartsuites.spark.ZeppelinRContext", "getJavaSparkContext"), envir = SparkR:::.sparkREnv)
}
assign(".sqlc", SparkR:::callJStatic("com.smartsuites.spark.ZeppelinRContext", "getSqlContext"), envir = SparkR:::.sparkREnv)
assign("sqlContext", get(".sqlc", envir = SparkR:::.sparkREnv), envir = .GlobalEnv)
assign(".zeppelinContext", SparkR:::callJStatic("com.smartsuites.spark.ZeppelinRContext", "getZeppelinContext"), envir = .GlobalEnv)
