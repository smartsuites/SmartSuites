...
import com.smartsuites.interpreter.InterpreterResult.Code.SUCCESS
import com.smartsuites.interpreter.InterpreterResult.Type.{HTML, IMG, TABLE, TEXT}
import com.smartsuites.interpreter.InterpreterResult.{Code, Type}
