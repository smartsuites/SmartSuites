...
/*
    ...
    this.barData = {
      ...
      datasets: [
        ...
        {
          label: 'Oracle SQL',
          backgroundColor: '#ff6c7d',
          borderColor: '#ff6c7d',
          data: [98]
        },
        {
          label: 'Kylin SQL',
          backgroundColor: '#6eff59',
          borderColor: '#6eff59',
          data: [108]
        },
        {
          label: 'Spark Streaming',
          backgroundColor: '#a83dff',
          borderColor: '#a83dff',
          data: [18]
        },
        {
          label: 'Flink',
          backgroundColor: '#57ffeb',
          borderColor: '#57ffeb',
          data: [37]
        },
        {
        ...
        {
          label: 'Hive SQL',
          backgroundColor: '#efb793',
          borderColor: '#efb793',
          data: [78]
        },
        {
          label: 'MarkDown',
          backgroundColor: '#9abeff',
          borderColor: '#9abeff',
          data: [68]
        },
        {
          label: 'R',
          backgroundColor: '#e2ff2b',
          borderColor: '#e2ff2b',
          data: [52]
        },
        {
          label: 'Python',
          backgroundColor: '#c7ff1f',
          borderColor: '#c7ff1f',
          data: [79]
        },
        {
          label: 'Mahout',
          backgroundColor: '#be8cb8',
          borderColor: '#be8cb8',
          data: [38]
        }
      ]
