...
export class ParagraphComponent implements OnInit,AfterViewInit {
    ...
    if (self.parentNote.paragraphs.length === 1) {
      ...
      this.confirmationService.confirm({
        ...
        accept: () => {
          ...
          let data = {
            currentParagraphId: self.paragraph.id
          }
          self.eventService.broadcast('moveFocusToNextParagraph', data)
        },
        reject: () => {}
      });
    }
  ...
  insertNew (position) {
    ...
    this.eventService.broadcast('insertParagraph', data)
  }
